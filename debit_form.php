...
$user_query = "SELECT * FROM user_details ORDER BY id DESC LIMIT 1"; // Assuming only one business user
...
<body>
    ...
    <div class=" w-full h-auto flex justify-around items-start align-top">
        <div class="w-full form-container">
            <h2 class="form-heading">Create Debit Note</h2>
            <form action="debitnote.php" method="post" target="_blank">
                <h3>Date: <?php echo $date; ?></h3>

                <div class="form-group">
                    <label for="debit_note">Debit Note Number</label>
                    <input type="text" id="debit_note" name="debit_note" placeholder="Enter Debit Note number"
                        required />
                </div>
        ...
        <div class="w-[800px] form-container">
            ...
            <div class="text-center mb-4">
                <input type="submit" value="Generate Debit Note" class="bg-green-500 text-white p-2 rounded cursor-pointer">
            </div>
            </form>
